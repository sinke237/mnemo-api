...
def test_sm2_lowest_passing_score(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_maximum_ease_factor(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_null_interval_days(new_memory_state: CardMemoryState) -> None:
