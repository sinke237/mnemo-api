...
def test_sm2_correct_answer_first_review(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_correct_answer_second_review(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_correct_answer_third_review(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_incorrect_answer_resets_progress(new_memory_state: CardMemoryState) -> None:
...
def test_sm2_ease_factor_decreases_on_low_score(new_memory_state: CardMemoryState) -> None:
    """Test that the ease factor decreases with a low score."""
    state = update_memory_state_after_answer(new_memory_state, 3)
    assert state.ease_factor < 2.5


def test_sm2_ease_factor_does_not_go_below_minimum(new_memory_state: CardMemoryState) -> None:
